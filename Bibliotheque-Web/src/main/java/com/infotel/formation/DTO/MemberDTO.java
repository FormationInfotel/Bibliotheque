...
public class MemberDTO implements Serializable {
	...
	public MemberDTO(long member_id, String member_lastname, String member_firstname, String member_email,
			String member_address, String member_password, long member_LibraryId) {
		super();
